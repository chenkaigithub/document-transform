 ...
 * @date 2016年6月13日
 */
public class ServerFailureRoute implements Route {
    ...
    public void service(ChannelHandlerContext ctx, HttpRequest request,
        ...
        Exception e = (Exception) attrribute.get("exception");
        responseContent.append(JSON.toJSONString(JsonResult
                .FailureJsonResult("server occurs some problem!errorMsg:" + e.getMessage(), e)));
