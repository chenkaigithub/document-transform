...
import com.iflytek.documenttransform.tranform.Mp42JpegTransform;
 ...
 * @date 2016年6月13日
 */
public class Mp42JpegRoute extends JsonRoute {
    protected Object doTransform(HttpRequest request) {
        ...
        Mp42JpegTransform mp42JpegTransform = new Mp42JpegTransform();
        @SuppressWarnings("serial")
        String jpegFileId = mp42JpegTransform.transform(mp4FileId, new HashMap<String, Object>() {
            {
