 ...
 * @date 2016年6月13日
 */
public class ForbiddenRoute implements Route {
    ...
    public void service(ChannelHandlerContext ctx, HttpRequest request,
        ...
        responseContent.append(JSON.toJSONString(JsonResult.FailureJsonResult(
                "your current ip[" + attrribute.get("remoteIp") + "] is forbidden to access !")));
